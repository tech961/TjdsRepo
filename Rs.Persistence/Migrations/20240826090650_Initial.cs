        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PhysicalPath = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                    Created = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    CreatedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    LastModified = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: false),
                    LastModifiedBy = table.Column<Guid>(type: "uniqueidentifier", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EstateOptions = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: true, defaultValue: 1),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    MinArea = table.Column<int>(type: "int", nullable: false),
                    MaxArea = table.Column<int>(type: "int", nullable: false),
                    RoomNumber = table.Column<byte>(type: "tinyint", nullable: false),
                    WcNumber = table.Column<byte>(type: "tinyint", nullable: false),
                    BathRoomNumber = table.Column<byte>(type: "tinyint", nullable: false),
