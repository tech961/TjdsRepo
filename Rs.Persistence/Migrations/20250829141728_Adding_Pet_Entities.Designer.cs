...
namespace Rs.Persistence.Migrations
{
    ...
    [Migration("20250829141728_Adding_Pet_Entities")]
    partial class Adding_Pet_Entities
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.ActivityRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("ActivityRecords", "Pet");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.MedicalRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("MedicalRecords", "Pet");
                });

            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.Pet", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.VaccinationRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.ToTable("VaccinationRecords", "Pet");
                });
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.ActivityRecord", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.Pets.Pet", "Pet")
                        .WithMany("Activities")
                        .HasForeignKey("PetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Rs.Domain.Aggregates.Pets.Pet", b =>
                {
                    b.HasOne("Rs.Domain.Aggregates.Auths.User", "Owner")
                        .WithMany()
